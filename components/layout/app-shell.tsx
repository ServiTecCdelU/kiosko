    ...
    <div className="flex min-h-screen flex-col lg:flex-row">
      ...
      <aside className="hidden w-60 shrink-0 flex-col border-r bg-sidebar text-sidebar-foreground lg:flex">
        <div className="flex items-center gap-2 px-5 py-4">
          ...
          <span className="font-bold">Kiosko Despensa</span>
        </div>
      ...
      {/* Top nav mobile */}
      <header className="flex items-center gap-2 overflow-x-auto border-b bg-sidebar px-3 py-2 text-sidebar-foreground lg:hidden">
        {items.map((item) => {
          const active = pathname === item.href;
          return (
            <Link
